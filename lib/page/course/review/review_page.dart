...
class ShowReviewPage extends StatelessWidget {
  ...
  ShowReviewPage({Key? key, required this.courseId}) : super(key: key);
        ...
        onPressed: () {
          final _ratingDialog = RatingDialog(
            image: ClipRRect(
                ...
                child: Image.asset(
                  "assets/images/othersPic/rating.png",
                  height: 100,
                )),
            ...
            onSubmitted: (response) {
              ...
              Provider.of<FeedBackService>(context, listen: false).rating(
                  courseId!,
                  response.rating,
          ...
          //     .rating(courseId, rating, userID, comment);
        },
        backgroundColor: const Color.fromRGBO(0, 181, 116, 1),
        label: const Text("Give Some FeedBack"),
      ),
